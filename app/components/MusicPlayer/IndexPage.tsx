...
import { albumIdState, mudicIDState, oneArrayMusicState, playerDisplayState } from "@/app/states";
  ...
  useEffect(() => {
    if (musicID && token) {
      axios
        ...
        .then((r) => {
          setFetchMusic(r.data.filePath);
          setPlayerDisplay(r.data);
          console.log(audioRef, 'audioPlayer');
    ...
    <div className={style.main}>
      ...
      <div className={style.container}>
        ...
        <Controls
          ...
          duration={duration}
          onTimeChange={handleTimeChange}
          backgroundImage={playerDisplay?.album?.coverImage}
          name={playerDisplay?.trackTitle}
          isActive={isPlaying}
        />
