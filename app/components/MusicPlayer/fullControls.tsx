    ...
    return (
        <>
            ...
            <div className={style.container}>
                ...
                <div className={style.buttons}>
                    ...
                    <button onClick={props.onToggleLoop} className={style.btn}>
                        <Icon name={props.isLooping ? "/images/repeat-one.png" : "repeat"} alt="Loop" width={24} height={24} />
                    </button>
                </div>
            ...
            <div className={style.volume}>
                <Image src="/images/volume-loud.png" alt="Volume" className={style.volimg} width={24} height={24} />
                <input
                    type="range"
                    min="0"
                    max="100"
